...
drop constraint if exists event_invites_identifier_check;

alter table public.event_invites
add constraint event_invites_identifier_check
check (
  invitee_email_lc is not null
  or invitee_phone_e164 is not null

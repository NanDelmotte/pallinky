...
add_landing_metadata_description: 'Open Pallinky om deze persoon aan je contacten toe te voegen.',
add_landing_fallback_name: 'Iemand',
add_landing_badge: 'Pallinky-contactverzoek',
add_landing_title: '{name} toevoegen op Pallinky',
add_landing_body: 'Open Pallinky om deze persoon aan je contacten toe te voegen en samen plannen te maken.',
...
add_landing_installed_hint: 'Heb je Pallinky net geïnstalleerd? Kom terug naar deze pagina en tik op Openen in Pallinky.',
...
people_second_degree_card_hint: 'Jullie zijn verbonden via gemeenschappelijke mensen.',
  ...
  profile_qr_subtitle: 'Scan deze QR-code om mij toe te voegen aan Pallinky-contacten.',

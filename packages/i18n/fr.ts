...
add_landing_metadata_description: 'Ouvrez Pallinky pour ajouter cette personne à vos contacts.',
...
add_landing_body: 'Ouvrez Pallinky pour ajouter cette personne à vos contacts et commencer à organiser des plans ensemble.',
...
add_landing_installed_hint: 'Si vous venez d’installer Pallinky, revenez sur cette page et touchez Ouvrir dans Pallinky.',
...
people_second_degree_card_hint: 'Vous êtes connectés par des personnes en commun.',
  ...
  profile_permission_needed_body: 'Veuillez autoriser l’accès à la photothèque.',
  ...
  profile_qr_subtitle: 'Scannez ce QR code pour m’ajouter aux contacts Pallinky.',
